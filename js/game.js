(function(){
    var lastTime = 0;
    var vendors = ['mz', 'moz', 'webkit', 'o'];
    for(var x= 0; x<vendors.length && !window.requestAnimationFrame; ++x){
        window.requestAnimationFrame = window[vendors[x] + 'RequestAnimationFrame'];
        window.cancelAnimationFrame = window[vendor[x] + 'CancelAnimationFrame'] || window[vendor[x] + 'CancelRequesAnimationFrame'];
    }
...
var levels = {
    ...
    // Load all data and images for specific level
    load:function(number){
        ...
        if(loader.loaded){
            ...
            loader.onload = function(){game.start();};
        }
    }
}
...
var loader = {
    ...
    init:function(){
        ...
        // Check for ogg, then mp3, and finally set soundFilExtn to undefined
